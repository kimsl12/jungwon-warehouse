  ...
  return (
    <ResponsiveContainer width="100%" height={280}>
      <ComposedChart data={data} margin={{ top: 8, right: 12, left: -8, bottom: 0 }}>
        ...
        />
        <Bar yAxisId="left" dataKey="inCount" fill={COLORS.inBar} radius={[2, 2, 0, 0]} barSize={16} />
        <Bar yAxisId="left" dataKey="outCount" fill={COLORS.outBar} radius={[2, 2, 0, 0]} barSize={16} />
